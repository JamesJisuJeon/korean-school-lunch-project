...
import { Users, Calendar, Filter, RefreshCw, Check } from "lucide-react";
        ...
        <div className="bg-white dark:bg-gray-900 shadow-2xl border border-gray-200 dark:border-gray-800 rounded-3xl overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-800">
            ...
            <tbody className="bg-white dark:bg-gray-900 divide-y divide-gray-100 dark:divide-gray-800">
              ...
              {students.length === 0 && (
                <tr>
                  <td colSpan={6} className="py-20 text-center text-gray-300 dark:text-gray-600 font-bold italic">
                    이 학급에 배정된 학생이 없습니다.
                  </td>
                </tr>
              )}
