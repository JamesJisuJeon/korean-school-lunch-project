...
export default function SalesManagementClient() {
  ...
  const displayedStudents = useMemo(() => {
    ...
    return result;
  }, [students, searchTerm, filterClass, filterOrderType, filterStatus, sortKey, sortDir]);
  ...
  const selectClass = "rounded-xl border-2 border-gray-100 dark:border-gray-700 bg-white dark:bg-gray-800 text-xs font-black text-gray-700 dark:text-gray-200 py-2 px-3 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 appearance-none cursor-pointer transition-all";
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-white dark:bg-gray-900 rounded-[2.5rem] shadow-sm border border-gray-200 dark:border-gray-800 overflow-hidden">
        <div className="p-6 border-b border-gray-50 dark:border-gray-800 bg-gray-50/30 dark:bg-gray-800/30 space-y-4">
          {/* 검색창 */}
          <div className="relative flex-1 group">
            ...
            <input
              className="pl-12 w-full h-14 bg-white dark:bg-gray-800 rounded-2xl border-2 border-gray-100 dark:border-gray-700 focus:border-blue-600 dark:focus:border-blue-400 focus:ring-0 font-bold transition-all text-gray-900 dark:text-gray-100 placeholder:text-gray-400 dark:placeholder:text-gray-500 outline-none"
          ...
          <div className="flex flex-wrap items-center gap-3">
            <div className="flex items-center gap-1.5 text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest">
              ...
              필터
              {activeFilterCount > 0 && (
                <span className="ml-1 w-4 h-4 flex items-center justify-center bg-blue-600 text-white rounded-full text-[9px] font-black">
                  {activeFilterCount}
                </span>
              )}
            </div>
            ...
            {activeFilterCount > 0 && (
              <button
                onClick={() => { setFilterClass("ALL"); setFilterOrderType("ALL"); setFilterStatus("ALL"); }}
                className="flex items-center gap-1 px-3 py-2 text-[10px] font-black text-red-500 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-xl border border-red-100 dark:border-red-800 transition-colors"
              >
